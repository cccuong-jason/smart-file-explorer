...
export function ResizableLayout({ sidebar, content, preview }: ResizableLayoutProps) {
    ...
    return (
        <div className="flex h-[calc(100vh-64px)] overflow-hidden bg-gray-50 select-none">
            ...
            {/* Resizer 1 */}
            <div
                className="w-1 cursor-col-resize hover:bg-indigo-400 active:bg-indigo-600 transition-colors bg-gray-200 z-10"
            ...
            {/* Resizer 2 */}
            <div
                className="w-1 cursor-col-resize hover:bg-indigo-400 active:bg-indigo-600 transition-colors bg-gray-200 z-10 hidden xl:block"
                onMouseDown={startResizingPreview}
            />

            {/* Preview */}
            <aside
                className="shrink-0 bg-gray-50 overflow-y-auto hidden xl:block border-l border-gray-100"
